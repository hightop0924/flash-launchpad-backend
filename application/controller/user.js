...
exports.read = function (req, res) {
    ...
    exports.model.User
        ...
        .then(function (err, rec) {
            res.send({success: true, Users: rec});
        });
};
...
exports.update = function (req, res) {
    ...
    exports.model.User.update({"_id": id},{ $set : params}, {upsert:false})
        .then(function (err) {
            if(!err) {
...
exports.destroy = function (req, res) {
    ...
    exports.model.User.remove({"_id": params._id})
        .then(function (err) {
            if(!err) {
                res.send({success: true});
            }
...
exports.signin = async (req, res)=> {
    ...
    try {
        const existingUser = await exports.model.User.findOne({ email })
...
exports.signup = async (req, res)=> {
    ...
    try {
        ...
        const user = new exports.model.User({ email, password: hashedPassword, name})
